...
class TextReplayer:
    ...
    def execute_run(self, cmd_file, param_dict, vision_engine, template_path=None, project=None, sample_index=0, should_pause_fn=None):
        ...
        for line in lines:
            ...
            if cmd.startswith("wait for simulation to finish with timeout"):
                ...
                success = vision_engine.wait_for_completion(template_path, roi_coords, max_wait=timeout, should_pause_fn=should_pause_fn)
                if not success:
